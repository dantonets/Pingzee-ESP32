...
#ifndef COMPONENTS_BUS_SPI_INCLUDE_FONT_H_
#define COMPONENTS_BUS_SPI_INCLUDE_FONT_H_

/*======= binar input =======*/
#define bits2bytes(b7,b6,b5,b4,b3,b2,b1,b0) ((uint8_t)((b7<<7)|(b6<<6)|(b5<<5)|(b4<<4)|(b3<<3)|(b2<<2)|(b1<<1)|(b0<<0)))

/*======= Character pointers table =======*/
extern const uint8_t *font_table[95];
...
#endif /* COMPONENTS_BUS_SPI_INCLUDE_FONT_H_ */
