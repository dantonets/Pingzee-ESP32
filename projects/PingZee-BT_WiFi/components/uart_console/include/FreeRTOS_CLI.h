...
#ifndef COMPONENTS_UART_CONSOLE_INCLUDE_FREERTOS_CLI_H_
#define COMPONENTS_UART_CONSOLE_INCLUDE_FREERTOS_CLI_H_
...
#endif /* COMPONENTS_UART_CONSOLE_INCLUDE_FREERTOS_CLI_H_ */
